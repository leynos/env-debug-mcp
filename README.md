...
- **Safe inspection**: Variables with KEY, TOKEN, CRED, SECRET, AUTH, PASSWORD,
  or PASSPHRASE at word boundaries have their values automatically redacted
...
- Redacts values for variables with KEY, TOKEN, CRED, SECRET, AUTH, PASSWORD,
  or PASSPHRASE at word boundaries (case-insensitive)
